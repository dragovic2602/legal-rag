...
**Agent E — Online Research:**
Tilgår KUN godkendte sider fra `references/approved-sites.md`. Læser ingen uploadede PDF'er.
Placeholders: ingen direkte — al output går i notes
Notes: lokalplan (plannummer, navn, formål, bevaringsværdi, byggehøjde, materialer, fremtidigt byggeri); kommunens varmeplan (planlagte ændringer, tilslutningspligt, estimeret omkostning); spildevandsplan (kun parcelhuse, areal-specifik); virk.dk-svar på ejerforeningens CVR
