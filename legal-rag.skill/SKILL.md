---
name: legal-rag
description: Legal RAG system overview for a Danish law firm. Explains how to use the knowledge base, MCP tools (search_knowledge_base, list_documents), and search strategies for Danish legal documents.
---
